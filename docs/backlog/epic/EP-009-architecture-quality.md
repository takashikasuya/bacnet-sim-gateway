...
EP-009.1 依存単一化（#52）, EP-009.2 spec_to_oid 集約（#53）, EP-009.3 カプセル化（#54）,
EP-009.4 例外処理（#55）, EP-009.5 ライブ再読込（#56）, EP-009.6 型安全（#57）,
EP-009.7 ZeroMQ テスト（#58）, EP-009.8 MQTT テスト（#59）, EP-009.9 REST POST テスト（#60）,
EP-009.10 CI カバレッジ/format（#61）, EP-009.11 ジェネレータ規約（#62）。
