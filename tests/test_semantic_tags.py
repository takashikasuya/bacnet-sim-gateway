...
def test_search_tags_are_deduplicated(tmp_path):
    ...
    p = SbcoPoint(
        gateway_id="GW", device_id="D", device_name="d", device_type="Sensor", site="",
        building="b", floor="1F", installation_area="a", target_area="", panel="",
        point_type="Temperature", point_specification="Measurement", point_id="P1",
        point_name="n", writable=False, interval=None, unit="degC", max_pres_value=None,
        min_pres_value=None, labels=[], scale=1.0, tags=["room", "temp", "room"],
        supplier="", owner="", description="", local_id="L1", device_id_bacnet="",
        instance_no_bacnet=None, object_type_bacnet="Analog-Input",
    )
