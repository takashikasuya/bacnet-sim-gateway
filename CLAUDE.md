...
| ADR | `docs/adr/ADR-001..007` | なぜその設計か | **設計判断の正** |
| Backlog | `docs/backlog/` | 何を作るか（`PRD-v1.3.md` ＝製品要求、`epic/EP-001..006` ＝ MVP 別） | **製品要求の正** |
...
- `docs/backlog/PRD-v1.3.md` — product requirements (PR-F-*, PR-NF-*, AC-*, MVP phases)
